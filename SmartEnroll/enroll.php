...
$showStudentStatusField = $isBuiltinActive('student_status');
...
<form id="enrollmentForm" action="save_enrollment.php" method="POST">
    ...
    <?php if ($showStudentStatusField || $showCompletionDateField): ?>
        <div class="form-top">
            <?php if ($showStudentStatusField): ?>
                <div class="student-status-top-field">
                    <label for="studentStatusInput"><?php echo htmlspecialchars($builtinLabel('student_status')); ?>:</label>
                    <select id="studentStatusInput" name="student_status" <?php echo $fieldDisabledAttr('student_status'); ?>>
                        <option value="">Select Status</option>
                        <?php foreach (smartenroll_student_status_options() as $statusOption): ?>
    ...
    <section class="form-section">
        ...
        <div class="form-grid three emergency-contact-block emergency-contact-hidden" data-emergency-block="2">
            <div class="emergency-remove-wrapper">
